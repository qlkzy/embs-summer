...
#ifndef _toplevel_tiles_V_H_
#define _toplevel_tiles_V_H_
...
struct toplevel_tiles_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(toplevel_tiles_V_core);
    toplevel_tiles_V_core(sc_core::sc_module_name) {
...
SC_MODULE( toplevel_tiles_V )
{
    static const unsigned int DataWidth = 4;
    static const unsigned int AddressRange = 144;
    ...
    SC_CTOR( toplevel_tiles_V ) {
        meminst = new toplevel_tiles_V_core <2, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    toplevel_tiles_V_core <2, 1, DataWidth, AddressWidth, AddressRange>* meminst;
