...
struct toplevel_colours_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(toplevel_colours_V_core);
    toplevel_colours_V_core(sc_core::sc_module_name) {
...
SC_MODULE( toplevel_colours_V )
{
    static const unsigned int DataWidth = 36;
