...
#ifndef _toplevel_pp_tile_V_H_
#define _toplevel_pp_tile_V_H_
...
struct toplevel_pp_tile_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(toplevel_pp_tile_V_core);
    toplevel_pp_tile_V_core(sc_core::sc_module_name) {
...
SC_MODULE( toplevel_pp_tile_V )
{
    ...
    SC_CTOR( toplevel_pp_tile_V ) {
        meminst = new toplevel_pp_tile_V_core <2, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    toplevel_pp_tile_V_core <2, 1, DataWidth, AddressWidth, AddressRange>* meminst;
